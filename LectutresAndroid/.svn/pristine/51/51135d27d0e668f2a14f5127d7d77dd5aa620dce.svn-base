...
import com.example.administrator.lecturesmanagerdemo.adapter.CollectionLectureListAdapter;
...
public class CollectionListActivity extends XActivity implements OnItemClickListener, LFRecyclerView.LFRecyclerViewListener, LFRecyclerView.LFRecyclerViewScrollChange{
    ...
    private CollectionLectureListAdapter adapter;
    List<CollectionListResult.DataBean> dataBeen = new ArrayList<>();
    @Override
    ...
    public void initView() {
        ...
        queryLectures();
        adapter = new CollectionLectureListAdapter (dataBeen,getApplication());
...
//                list.add(list.size(), "leefeng.me" + "==onLoadMore");
    ...
    public void onClick(int position) {
        Intent intent = new Intent(CollectionListActivity.this, LectureDetailActivity.class);
    ...
    void queryLectures(){
        ...
        Call<CollectionListResult> call = service.lecturesCollectionQuerybyuserid(pageNo,pageSize,GlobalField.userid);
        //进行网络请求
        call.enqueue(new Callback<CollectionListResult>() {
            @Override
            public void onResponse(Call<CollectionListResult> call, Response<CollectionListResult> response) {
            ...
            @Override
            public void onFailure(Call<CollectionListResult> call, Throwable t) {
                XLog.e(t.getMessage());
            }
        });
    }
