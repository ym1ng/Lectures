...
public class GaoDeActivity extends AppCompatActivity  implements AMapLocationListener {
    ...
    Handler handler=new Handler(){
        ...
        public void handleMessage(Message msg) {
             ...
             * */
            //120.033587,30.222453
            String a="30.222453";
            String b="120.033587";
            LatLng latLng2=new LatLng(Double.parseDouble(a),Double.parseDouble(b));
            float distance = AMapUtils.calculateLineDistance(latLng,latLng2);
            XLog.i(distance+"米");
            textView.setText("当前定位点 lat:"+lat+"lon:"+lon+"\n目标点: lat: 32.101937, lon: 118.777595"+"\n距离："+distance+"米");
