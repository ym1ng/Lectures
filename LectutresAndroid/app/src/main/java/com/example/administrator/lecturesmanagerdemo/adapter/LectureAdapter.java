 ...
 */
public class LectureAdapter extends
        RecyclerView.Adapter<LectureAdapter.ViewHolder> implements View.OnClickListener{
    public List<LecturesResult.DataBean> datas = null;
    Context context;
    ...
    public LectureAdapter(List<LecturesResult.DataBean>
    ...
    public void onBindViewHolder(ViewHolder holder, int position ) {
        ...
        String title = datas.get(position).getLecturesname() ;
            holder.tvtitle.setText(title);
            holder.tvlectureaddress.setText( datas.get(position).getClassroom().getClassroomname());
        long datetime=datas.get(position).getLecturestime();
            holder.tvlecturetime.setText(DateFormatUtil.LongToDate(datetime));
            Glide.with(context)
                    .load(GlobalField.ImageURL+datas.get(position).getPoster())
                    .diskCacheStrategy
