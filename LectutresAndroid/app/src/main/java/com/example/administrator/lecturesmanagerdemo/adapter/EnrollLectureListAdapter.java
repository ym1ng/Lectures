 ...
 */
public class EnrollLectureListAdapter extends
        RecyclerView.Adapter<EnrollLectureListAdapter.ViewHolder> implements View.OnClickListener{
    public List<EnrollListResult.DataBean> datas = null;
    Context context;
    ...
    public EnrollLectureListAdapter(List<EnrollListResult.DataBean>
