...
<form  method="post" class="form form-horizontal" id="lecturesType-add">
		<input type="hidden" id="lecturestypeid" name="lecturestypeid" value="${lecturestype.lecturestypeid}" />
	
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>讲座类型名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${lecturestype.lecturestypename}" placeholder="" id="lecturestypename" name="lecturestypename">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="description" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" onKeyUp="textarealength(this,100)" value="${lecturestype.description}"></textarea>
