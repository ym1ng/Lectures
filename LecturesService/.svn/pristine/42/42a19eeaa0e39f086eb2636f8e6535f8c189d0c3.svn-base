...
<body>
	<nav class="breadcrumb">
		...
		学校管理 <span class="c-gray en">&gt;</span> 教室管理 <a
	...
	<div class="page-container">
		<div class="cl pd-5 bg-1 bk-gray">
			<span class="l"> <a class="btn btn-primary radius" href="javascript:;"
				onclick="classroom_add('添加教室','${ctx}/classroom/add','800')"><i
					class="Hui-iconfont">&#xe600;</i> 添加教室</a>
			</span> <span class="r">共有数据：<strong>${classroomlist.size()}</strong> 条
			</span>
		</div>
		<table class="table table-border table-bordered table-hover table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="6">教室管理</th>
				</tr>
				<tr class="text-c">
					<th width="25"><input type="checkbox" value="" name=""></th>
					<th width="40">教室ID</th>
					<th width="200">教室名</th>
					<th width="200">教室坐标</th>
					<th width="70">操作</th>
				</tr>
			</thead>
			<tbody>
				<c:forEach items="${classroomlist}" var="item">
					<tr class="text-c">
						...
						<td class="f-14"><a title="编辑" href="javascript:;"
							onclick="classroom_edit('教室编辑','${ctx}/classroom/edit?classroomid=' +${item.classroomid},'${item.classroomid}')"
							style="text-decoration: none"><i class="Hui-iconfont">&#xe6df;</i></a>
							<a title="删除" href="javascript:;"
							onclick="classroom_del(this,${item.classroomid})" class="ml-5"
	...
	<script type="text/javascript">
	   ...
	   function classroom_add(title,url,w,h){
