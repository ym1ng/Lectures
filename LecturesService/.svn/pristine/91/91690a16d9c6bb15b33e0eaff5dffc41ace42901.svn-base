...
<body>
	...
	<input type="hidden" id="classroomid" name="classroomid" value="${classroom.classroomid}" />
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>教室名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${classroom.classroomname}" placeholder="" id="classroomname" name="classroomname" datatype="*4-16" nullmsg="用户账户不能为空">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">教室坐标lat：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${classroom.lat}" placeholder="" id="" name="lat">
			</div>
		</div>	
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">教室坐标lng：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${classroom.lng}" placeholder="" id="" name="lng">
			</div>
		</div>	
		<div class="row cl">
