...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" id="signin-add">
		<input type="hidden" id="signinid" name="signinid" value="${signin.signinid}" />
	
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>讲座编号：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${signin.lecturesid}" placeholder="" id="lecturesid" name="lecturesid">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${signin.userid}" placeholder="" id="userid" name="userid">
			</div>
		</div>
